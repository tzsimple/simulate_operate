...
driver.get("https://kzcdn.jktz.gov.cn/#/")  # 进入台州预约口罩页面
sleep(1)
#查找元素
ele_submit=driver.find_element_by_class_name('jump-form van-button van-button--info van-button--normal van-button--block')
ele_submit.click()
sleep(1)
# 获取当前页面url
